...
from obfuscation.common_helper import create_int_metavar, is_macos
...
from obfuscation.face_helper import merge_matrix, paste_back, scale_face_landmark_5, warp_face_by_face_landmark_5
...
from obfuscation.processors.modules.age_modifier import choices as age_modifier_choices
from obfuscation.processors.modules.age_modifier.types import AgeModifierDirection, AgeModifierInputs
from obfuscation.processors.types import ProcessorOutputs
from obfuscation.program_helper import find_argument_group
from obfuscation.thread_helper import thread_semaphore
...
from obfuscation.vision import match_frame_color, read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		obfuscation.jobs.job_store.register_step_keys([ 'age_modifier_model', 'age_modifier_direction' ])
...
def forward(crop_vision_frame : VisionFrame, extend_vision_frame : VisionFrame, age_modifier_direction : AgeModifierDirection) -> VisionFrame:
	...
	if is_macos() and has_execution_provider('coreml'):
		age_modifier.set_providers([ obfuscation.choices.execution_provider_set.get('cpu') ])
