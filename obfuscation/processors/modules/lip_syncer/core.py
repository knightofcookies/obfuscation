...
from obfuscation import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, state_manager, translator, video_manager, voice_extractor
from obfuscation.audio import read_static_voice
...
from obfuscation.face_helper import create_bounding_box, paste_back, warp_face_by_bounding_box, warp_face_by_face_landmark_5
from obfuscation.face_masker import create_area_mask, create_box_mask, create_occlusion_mask
from obfuscation.face_selector import select_faces
from obfuscation.filesystem import has_audio, resolve_relative_path
from obfuscation.processors.modules.lip_syncer import choices as lip_syncer_choices
from obfuscation.processors.modules.lip_syncer.types import LipSyncerInputs, LipSyncerWeight
...
from obfuscation.types import ApplyStateItem, Args, AudioFrame, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		obfuscation.jobs.job_store.register_step_keys([ 'lip_syncer_model', 'lip_syncer_weight' ])
