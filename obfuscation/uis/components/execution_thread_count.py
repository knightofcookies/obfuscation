...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(obfuscation.choices.execution_thread_count_range),
		minimum = obfuscation.choices.execution_thread_count_range[0],
		maximum = obfuscation.choices.execution_thread_count_range[-1]
	)
