...
from obfuscation.types import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = obfuscation.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(obfuscation.choices.system_memory_limit_range),
		minimum = obfuscation.choices.system_memory_limit_range[0],
		maximum = obfuscation.choices.system_memory_limit_range[-1],
