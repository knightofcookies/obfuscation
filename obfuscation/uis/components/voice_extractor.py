...
from obfuscation import state_manager, translator, voice_extractor
from obfuscation.filesystem import is_video
from obfuscation.types import VoiceExtractorModel
...
def render() -> None:
	...
	VOICE_EXTRACTOR_MODEL_DROPDOWN = gradio.Dropdown(
		...
		choices = obfuscation.choices.voice_extractor_models,
