...
from obfuscation import content_analyser, core, state_manager
from obfuscation.cli_helper import render_table
from obfuscation.download import conditional_download, resolve_download_url
from obfuscation.face_store import clear_static_faces
from obfuscation.filesystem import get_file_extension
from obfuscation.types import BenchmarkCycleSet
from obfuscation.vision import count_video_frame_total, detect_video_fps
...
def run() -> Generator[List[BenchmarkCycleSet], None, None]:
	...
	benchmarks = []
	target_paths = [ obfuscation.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in obfuscation.choices.benchmark_set ]
